...
int32_t FunctionServlet::handle(myfiber::http::HttpRequest::ptr request
               , myfiber::http::HttpResponse::ptr response
               , myfiber::http::HttpSession::ptr session) {
...
ServletDispatch::ServletDispatch()
    ...
    m_default.reset(new NotFoundServlet("myfiber/1.0"));
}

int32_t ServletDispatch::handle(myfiber::http::HttpRequest::ptr request
               , myfiber::http::HttpResponse::ptr response
               , myfiber::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(myfiber::http::HttpRequest::ptr request
                   , myfiber::http::HttpResponse::ptr response
                   , myfiber::http::HttpSession::ptr session) {
    response->setStatus(myfiber::http::HttpStatus::NOT_FOUND);
    response->setHeader("Server", "myfiber/1.0.0");
