#ifndef __myfiber_HTTP_SESSION_DATA_H__
#define __myfiber_HTTP_SESSION_DATA_H__

#include "myfiber/mutex.h"
#include "myfiber/singleton.h"
...
typedef myfiber::Singleton<SessionDataManager> SessionDataMgr;
