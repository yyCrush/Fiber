 ...
 */
#ifndef __myfiber_HTTP_SERVLET_H__
#define __myfiber_HTTP_SERVLET_H__
...
public:
    ...
    virtual int32_t handle(myfiber::http::HttpRequest::ptr request
                   ...
                   , myfiber::http::HttpSession::ptr session) = 0;
...
public:
    ...
    /// 函数回调类型定义
    typedef std::function<int32_t (myfiber::http::HttpRequest::ptr request
                   , myfiber::http::HttpResponse::ptr response
                   , myfiber::http::HttpSession::ptr session)> callback;
...
public:
    ...
    /**
     * @brief 添加模糊匹配servlet
     * @param[in] uri uri 模糊匹配 /myfiber_*
