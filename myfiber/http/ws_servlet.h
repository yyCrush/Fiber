...
public:
    ...
    virtual int32_t handle(myfiber::http::HttpRequest::ptr request
                   , myfiber::http::HttpResponse::ptr response
                   , myfiber::http::HttpSession::ptr session) override {
        return 0;
    }

    virtual int32_t onConnect(myfiber::http::HttpRequest::ptr header
                              ,myfiber::http::WSSession::ptr session) = 0;
    virtual int32_t onClose(myfiber::http::HttpRequest::ptr header
                             ,myfiber::http::WSSession::ptr session) = 0;
    virtual int32_t handle(myfiber::http::HttpRequest::ptr header
...
public:
    ...
    typedef std::function<int32_t (myfiber::http::HttpRequest::ptr header
                              ,myfiber::http::WSSession::ptr session)> on_connect_cb;
    typedef std::function<int32_t (myfiber::http::HttpRequest::ptr header
                             ,myfiber::http::WSSession::ptr session)> on_close_cb; 
    typedef std::function<int32_t (myfiber::http::HttpRequest::ptr header
                           ,myfiber::http::WSFrameMessage::ptr msg
                           ,myfiber::http::WSSession::ptr session)> callback;
    ...
    virtual int32_t onConnect(myfiber::http::HttpRequest::ptr header
                              ,myfiber::http::WSSession::ptr session) override;
    virtual int32_t onClose(myfiber::http::HttpRequest::ptr header
                             ,myfiber::http::WSSession::ptr session) override;
    virtual int32_t handle(myfiber::http::HttpRequest::ptr header
                           ,myfiber::http::WSFrameMessage::ptr msg
