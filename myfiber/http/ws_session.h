#ifndef __myfiber_HTTP_WS_SESSION_H__
#define __myfiber_HTTP_WS_SESSION_H__

#include "myfiber/config.h"
#include "myfiber/http/http_session.h"
#include <stdint.h>
...
extern myfiber::ConfigVar<uint32_t>::ptr g_websocket_message_max_size;
