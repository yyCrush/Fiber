#ifndef __myfiber_ADDRESS_H__
#define __myfiber_ADDRESS_H__
#include <memory>
#include <string>
#include <sys/types.h>
...
public:
     ...
     * @param[in] host 域名,服务器名等.举例: www.myfiber.top[:80] (方括号为可选内容)
...
public:
     ...
     * @param[in] address 域名,IP,服务器名等.举例: www.myfiber.top
     * @param[in] port 端口号
